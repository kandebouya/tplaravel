...
/** Lien details pour afficher l'information sur un étudiant */
...
/** Lien suppression  pour afficher le formulaire de modification d'un étudiant */
Route::get('etudiants/destroy/{id}', 'EtudiantController@destroy')->name('deleteEtudiant');
